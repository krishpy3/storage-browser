...
function App() {
  ...
  const handleSignOut = async () => {
    ...
    const cognitoLogoutUrl = `https://64d24683309ce5cfce78.auth.us-east-1.amazoncognito.com/logout?client_id=1j2u7spdithuthome35lh84pg1&logout_uri=${encodeURIComponent(microsoftLogoutUrl)}`;

    // Let Cognito handle the redirect to Microsoft logout
